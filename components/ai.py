...
class ConfusedEnemy(BaseAI):
    ...
    def perform(self) -> None:
        # Revert the AI back to original state if the effect has run its
        # course.
        if self.turns_remaining <= 0:
            ...
            # direction. It is possibe the actor will just bump into a wall,
            # wasting a turn.
