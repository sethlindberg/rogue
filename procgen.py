...
# tuple is (floor number, high range)
max_items_by_floor = [
    (1, 1),
    (4, 2),
    (7, 3),
...
enemy_chances: Dict[int, List[Tuple[Entity, int]]] = {
    0: [(entity_factories.orc, 40), (entity_factories.kobold, 80)],
    3: [(entity_factories.orc, 80), (entity_factories.troll, 15), (entity_factories.kobold, 20)],
...
def place_entities(room: RectangularRoom, dungeon: GameMap, floor_number: int,) -> None:
    """Function to place all the actors and objects into the dungeon"""
